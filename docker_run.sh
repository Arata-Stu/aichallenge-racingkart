...
usage() {
    cat <<'EOF'
Usage:
  ./docker_run.sh dev [auto|gpu|cpu] [--name NAME] [--no-exec] [--recreate]
  ./docker_run.sh eval [auto|gpu|cpu] [--name NAME] [--no-exec] [--recreate]
  ./docker_run.sh exec [NAME]
  ./docker_run.sh stop [NAME]
  ./docker_run.sh down [NAME]
  ./docker_run.sh rm

Examples:
  ./docker_run.sh dev
  ./docker_run.sh dev cpu
  ./docker_run.sh dev --no-exec
  ./docker_run.sh exec
...
init_log() {
    ...
    ln -sfn "${SCRIPT_DIR}/${log_file}" output/latest/docker_run.log
}
...
log "[INFO] To enter later: ./docker_run.sh exec ${container_name}"
log "[INFO] To stop/remove: ./docker_run.sh down ${container_name}"
